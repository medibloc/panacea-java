...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return tendermint.types.Params.internal_static_tendermint_types_ValidatorParams_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            tendermint.types.ValidatorParams.class, tendermint.types.ValidatorParams.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof tendermint.types.ValidatorParams)) {
      return super.equals(obj);
    }
    tendermint.types.ValidatorParams other = (tendermint.types.ValidatorParams) obj;
  ...
  public static tendermint.types.ValidatorParams parseFrom(
  ...
  public static tendermint.types.ValidatorParams parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static tendermint.types.ValidatorParams parseFrom(
  ...
  public static tendermint.types.ValidatorParams parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static tendermint.types.ValidatorParams parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static tendermint.types.ValidatorParams parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(tendermint.types.ValidatorParams prototype) {
  ...
  public static final class Builder extends
      ...
      tendermint.types.ValidatorParamsOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return tendermint.types.Params.internal_static_tendermint_types_ValidatorParams_descriptor;
    }
    ...
    // Construct using tendermint.types.ValidatorParams.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public tendermint.types.ValidatorParams getDefaultInstanceForType() {
      return tendermint.types.ValidatorParams.getDefaultInstance();
    }

    @java.lang.Override
    public tendermint.types.ValidatorParams build() {
      tendermint.types.ValidatorParams result = buildPartial();
    ...
    @java.lang.Override
    public tendermint.types.ValidatorParams buildPartial() {
      tendermint.types.ValidatorParams result = new tendermint.types.ValidatorParams(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof tendermint.types.ValidatorParams) {
        return mergeFrom((tendermint.types.ValidatorParams)other);
      } else {
    ...
    public Builder mergeFrom(tendermint.types.ValidatorParams other) {
      if (other == tendermint.types.ValidatorParams.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      tendermint.types.ValidatorParams parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (tendermint.types.ValidatorParams) e.getUnfinishedMessage();
  ...
  private static final tendermint.types.ValidatorParams DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new tendermint.types.ValidatorParams();
  }

  public static tendermint.types.ValidatorParams getDefaultInstance() {
