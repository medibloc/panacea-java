...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return tendermint.crypto.Keys.internal_static_tendermint_crypto_PublicKey_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            tendermint.crypto.PublicKey.class, tendermint.crypto.PublicKey.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof tendermint.crypto.PublicKey)) {
      return super.equals(obj);
    }
    tendermint.crypto.PublicKey other = (tendermint.crypto.PublicKey) obj;
  ...
  public static tendermint.crypto.PublicKey parseFrom(
  ...
  public static tendermint.crypto.PublicKey parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static tendermint.crypto.PublicKey parseFrom(
  ...
  public static tendermint.crypto.PublicKey parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static tendermint.crypto.PublicKey parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static tendermint.crypto.PublicKey parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(tendermint.crypto.PublicKey prototype) {
  ...
  public static final class Builder extends
      ...
      tendermint.crypto.PublicKeyOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return tendermint.crypto.Keys.internal_static_tendermint_crypto_PublicKey_descriptor;
    }
    ...
    // Construct using tendermint.crypto.PublicKey.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public tendermint.crypto.PublicKey getDefaultInstanceForType() {
      return tendermint.crypto.PublicKey.getDefaultInstance();
    }

    @java.lang.Override
    public tendermint.crypto.PublicKey build() {
      tendermint.crypto.PublicKey result = buildPartial();
    ...
    @java.lang.Override
    public tendermint.crypto.PublicKey buildPartial() {
      tendermint.crypto.PublicKey result = new tendermint.crypto.PublicKey(this);
      if (sumCase_ == 1) {
        result.sum_ = sum_;
      }
      if (sumCase_ == 2) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof tendermint.crypto.PublicKey) {
        return mergeFrom((tendermint.crypto.PublicKey)other);
      } else {
    ...
    public Builder mergeFrom(tendermint.crypto.PublicKey other) {
      if (other == tendermint.crypto.PublicKey.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      tendermint.crypto.PublicKey parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (tendermint.crypto.PublicKey) e.getUnfinishedMessage();
  ...
  private static final tendermint.crypto.PublicKey DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new tendermint.crypto.PublicKey();
  }

  public static tendermint.crypto.PublicKey getDefaultInstance() {
