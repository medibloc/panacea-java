...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return cosmos.gov.v1beta1.Gov.internal_static_cosmos_gov_v1beta1_Vote_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            cosmos.gov.v1beta1.Vote.class, cosmos.gov.v1beta1.Vote.Builder.class);
  }
   ...
   * <code>.cosmos.gov.v1beta1.VoteOption option = 3;</code>
   */
  public cosmos.gov.v1beta1.VoteOption getOption() {
    @SuppressWarnings("deprecation")
    cosmos.gov.v1beta1.VoteOption result = cosmos.gov.v1beta1.VoteOption.valueOf(option_);
    return result == null ? cosmos.gov.v1beta1.VoteOption.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (option_ != cosmos.gov.v1beta1.VoteOption.VOTE_OPTION_UNSPECIFIED.getNumber()) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof cosmos.gov.v1beta1.Vote)) {
      return super.equals(obj);
    }
    cosmos.gov.v1beta1.Vote other = (cosmos.gov.v1beta1.Vote) obj;
  ...
  public static cosmos.gov.v1beta1.Vote parseFrom(
  ...
  public static cosmos.gov.v1beta1.Vote parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static cosmos.gov.v1beta1.Vote parseFrom(
  ...
  public static cosmos.gov.v1beta1.Vote parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static cosmos.gov.v1beta1.Vote parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static cosmos.gov.v1beta1.Vote parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(cosmos.gov.v1beta1.Vote prototype) {
  ...
  public static final class Builder extends
      ...
      cosmos.gov.v1beta1.VoteOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return cosmos.gov.v1beta1.Gov.internal_static_cosmos_gov_v1beta1_Vote_descriptor;
    }
    ...
    // Construct using cosmos.gov.v1beta1.Vote.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public cosmos.gov.v1beta1.Vote getDefaultInstanceForType() {
      return cosmos.gov.v1beta1.Vote.getDefaultInstance();
    }

    @java.lang.Override
    public cosmos.gov.v1beta1.Vote build() {
      cosmos.gov.v1beta1.Vote result = buildPartial();
    ...
    @java.lang.Override
    public cosmos.gov.v1beta1.Vote buildPartial() {
      cosmos.gov.v1beta1.Vote result = new cosmos.gov.v1beta1.Vote(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof cosmos.gov.v1beta1.Vote) {
        return mergeFrom((cosmos.gov.v1beta1.Vote)other);
      } else {
    ...
    public Builder mergeFrom(cosmos.gov.v1beta1.Vote other) {
      if (other == cosmos.gov.v1beta1.Vote.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      cosmos.gov.v1beta1.Vote parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (cosmos.gov.v1beta1.Vote) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
     ...
     * <code>.cosmos.gov.v1beta1.VoteOption option = 3;</code>
     */
    public Builder setOption(cosmos.gov.v1beta1.VoteOption value) {
      if (value == null) {
        throw new NullPointerException();
      }
  ...
  private static final cosmos.gov.v1beta1.Vote DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new cosmos.gov.v1beta1.Vote();
  }

  public static cosmos.gov.v1beta1.Vote getDefaultInstance() {
