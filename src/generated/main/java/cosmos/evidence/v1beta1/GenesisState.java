...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return cosmos.evidence.v1beta1.Genesis.internal_static_cosmos_evidence_v1beta1_GenesisState_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            cosmos.evidence.v1beta1.GenesisState.class, cosmos.evidence.v1beta1.GenesisState.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof cosmos.evidence.v1beta1.GenesisState)) {
      return super.equals(obj);
    }
    cosmos.evidence.v1beta1.GenesisState other = (cosmos.evidence.v1beta1.GenesisState) obj;
  ...
  public static cosmos.evidence.v1beta1.GenesisState parseFrom(
  ...
  public static cosmos.evidence.v1beta1.GenesisState parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static cosmos.evidence.v1beta1.GenesisState parseFrom(
  ...
  public static cosmos.evidence.v1beta1.GenesisState parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static cosmos.evidence.v1beta1.GenesisState parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static cosmos.evidence.v1beta1.GenesisState parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(cosmos.evidence.v1beta1.GenesisState prototype) {
  ...
  public static final class Builder extends
      ...
      cosmos.evidence.v1beta1.GenesisStateOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return cosmos.evidence.v1beta1.Genesis.internal_static_cosmos_evidence_v1beta1_GenesisState_descriptor;
    }
    ...
    // Construct using cosmos.evidence.v1beta1.GenesisState.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public cosmos.evidence.v1beta1.GenesisState getDefaultInstanceForType() {
      return cosmos.evidence.v1beta1.GenesisState.getDefaultInstance();
    }

    @java.lang.Override
    public cosmos.evidence.v1beta1.GenesisState build() {
      cosmos.evidence.v1beta1.GenesisState result = buildPartial();
    ...
    @java.lang.Override
    public cosmos.evidence.v1beta1.GenesisState buildPartial() {
      cosmos.evidence.v1beta1.GenesisState result = new cosmos.evidence.v1beta1.GenesisState(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof cosmos.evidence.v1beta1.GenesisState) {
        return mergeFrom((cosmos.evidence.v1beta1.GenesisState)other);
      } else {
    ...
    public Builder mergeFrom(cosmos.evidence.v1beta1.GenesisState other) {
      if (other == cosmos.evidence.v1beta1.GenesisState.getDefaultInstance()) return this;
      if (evidenceBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      cosmos.evidence.v1beta1.GenesisState parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (cosmos.evidence.v1beta1.GenesisState) e.getUnfinishedMessage();
  ...
  private static final cosmos.evidence.v1beta1.GenesisState DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new cosmos.evidence.v1beta1.GenesisState();
  }

  public static cosmos.evidence.v1beta1.GenesisState getDefaultInstance() {
