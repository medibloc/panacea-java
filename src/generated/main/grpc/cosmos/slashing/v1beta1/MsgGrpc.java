...
public final class MsgGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<cosmos.slashing.v1beta1.MsgUnjail,
      cosmos.slashing.v1beta1.MsgUnjailResponse> getUnjailMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Unjail",
      requestType = cosmos.slashing.v1beta1.MsgUnjail.class,
      responseType = cosmos.slashing.v1beta1.MsgUnjailResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<cosmos.slashing.v1beta1.MsgUnjail,
      cosmos.slashing.v1beta1.MsgUnjailResponse> getUnjailMethod() {
    io.grpc.MethodDescriptor<cosmos.slashing.v1beta1.MsgUnjail, cosmos.slashing.v1beta1.MsgUnjailResponse> getUnjailMethod;
    if ((getUnjailMethod = MsgGrpc.getUnjailMethod) == null) {
      synchronized (MsgGrpc.class) {
        if ((getUnjailMethod = MsgGrpc.getUnjailMethod) == null) {
          MsgGrpc.getUnjailMethod = getUnjailMethod = 
              io.grpc.MethodDescriptor.<cosmos.slashing.v1beta1.MsgUnjail, cosmos.slashing.v1beta1.MsgUnjailResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "cosmos.slashing.v1beta1.Msg", "Unjail"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cosmos.slashing.v1beta1.MsgUnjail.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  cosmos.slashing.v1beta1.MsgUnjailResponse.getDefaultInstance()))
  ...
  public static abstract class MsgImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void unjail(cosmos.slashing.v1beta1.MsgUnjail request,
        io.grpc.stub.StreamObserver<cosmos.slashing.v1beta1.MsgUnjailResponse> responseObserver) {
  ...
  public static final class MsgBlockingStub extends io.grpc.stub.AbstractStub<MsgBlockingStub> {
     ...
     * </pre>
     */
    public cosmos.slashing.v1beta1.MsgUnjailResponse unjail(cosmos.slashing.v1beta1.MsgUnjail request) {
  ...
  public static final class MsgFutureStub extends io.grpc.stub.AbstractStub<MsgFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<cosmos.slashing.v1beta1.MsgUnjailResponse> unjail(
        cosmos.slashing.v1beta1.MsgUnjail request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UNJAIL:
          serviceImpl.unjail((cosmos.slashing.v1beta1.MsgUnjail) request,
              (io.grpc.stub.StreamObserver<cosmos.slashing.v1beta1.MsgUnjailResponse>) responseObserver);
          break;
        default:
